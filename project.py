...
def fazer_backup(base):
    ...
    # Copiar somente arquivos .acf da biblioteca (para LuaTools)
    ...
    # Renomear para .rar se quiser compatibilidade LuaTools
